...
var app = new Vue({
    ...
    methods: {
        ...
        hideInformation: function hideInformation() {
            this.app.information = false;
        },
        showEmoji: function showEmoji() {

            var code = ':' + this.emojis[this.step].short + ':';
        ...
        canProgress: function canProgress() {
            if (this.semantic.trim() != '') {
                return true;
            }
            return false;
        },
        isNotFinalEmoji: function isNotFinalEmoji() {
            if (this.emojis.length - 1 > this.step) {
                return true;
            }
            return false;
        },
        storeEmojiData: function storeEmojiData() {
        ...
        restart: function restart() {
            ...
            axios.get('restart').then(function (response) {
